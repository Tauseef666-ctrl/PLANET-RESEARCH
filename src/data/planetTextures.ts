...
export const PLANET_TEXTURES: Record<string, { map: string; clouds?: string; night?: string; bump?: string; normal?: string; emissive?: string }> = {
  mercury: {
    map: `${COMMONS}/d/d9/Mercury_in_color_-_Prockter07-edit1.jpg`,
  },
  venus: {
    map: `${COMMONS}/8/85/Venus_globe.jpg`,
  },
  earth: {
    map: `${THREEJS_BASE}/earth_day_4096.jpg`,
  },
  mars: {
    map: `${COMMONS}/5/56/Mars_Valles_Marineris.jpeg`,
  },
  jupiter: {
    map: `${COMMONS}/2/2b/Jupiter_and_its_shrunken_Great_Red_Spot.jpg`,
  },
  saturn: {
    map: `${COMMONS}/c/c7/Saturn_during_Equinox.jpg`,
  },
  uranus: {
    map: `${COMMONS}/3/3d/Uranus2.jpg`,
  },
  neptune: {
    map: `${COMMONS}/5/56/Neptune_Full.jpg`,
  },
}
